...
router.post('/',[
    check('friend').isLength({min: 7}).withMessage("O nome precisar ter no minimo 7 caracteres."),
...
router.put('/:id', [
    check('friend').optional().isLength({min: 7}).withMessage("O nome precisar ter no minimo 7 caracteres."),
